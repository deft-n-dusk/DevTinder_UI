    ...
    <div className='text-center justify-center my-5 h-[76vh]'>
        <h1 className='text-bold text-3xl'>Connection Requests</h1>
        {
            requests.map((request) => {
                ...
                return(
                    <div key={_id} className='flex relative  m-8 mx-auto rounded-lg border border-gray-500 bg-base-300 w-4/12 '>
                        ...
                        <div className='flex gap-2 bottom-1 mb-3 absolute right-5'>
